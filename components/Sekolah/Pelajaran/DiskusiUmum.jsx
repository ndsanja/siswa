      ...
      <Grid className="grid-cols-12 gap-6">
        <div className="col-span-4">
          <Grid className="gap-6">
            ...
            <Card className=" bg-white shadow-z12-light-shadow rounded-xl text-textColor-primary-light text-sm font-semibold p-4">
              <div className="space-y-4">
                <h1 className="text-textColor-secondary-light">ATURAN FORUM</h1>
                <ul className="space-y-2 list-outside list-decimal pl-4 font-semibold">
                  <li>
            ...
            <Card className=" bg-white shadow-z12-light-shadow rounded-xl">
              <Flex className="flex-col p-6 space-y-6">
                <textarea
                  name=""
                  id=""
                  placeholder="Kirim sesuatu di Forum ini..."
